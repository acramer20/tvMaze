  ...
  for (let show of shows) {
    let $item = $(
      `<div class="col-md-6 col-lg-3 Show" data-show-id="${show.id}">
         ...
         <button type="submit" class="btn btn-primary episode-list">Episodes</button>
       </div>
      `);
...
$("#shows-list").on("click", ".episode-list", async function handleEpisodeClick(evt){
  let showId = $(evt.target).parent().data('show-id');
